        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">الأسئلة
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">الأسئلة</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <form class="mb-5 fv-plugins-bootstrap5 fv-plugins-framework" id="details_form"
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-6 mb-lg-0 mb-6">
                                    ...
                                    <input id="quastion_ar"
                                        class="form-control ps-12 datatable-input flatpickr-input active"
                                        placeholder="ادخل نص السؤال " name="quastion[ar]" type="text" value="">
                                </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', ".del_rec_btn", function(e) {
                ...
                let url = "{{ route('quastions.destroy', ':id') }}";
    ...
    <script>
        $('#add').on('click', function() {
            $.ajax({
                type: "POST",
                url: "{{ route('quastions.store') }}",
                data: {
                    'quastion[ar]': $('#quastion_ar').val(),
