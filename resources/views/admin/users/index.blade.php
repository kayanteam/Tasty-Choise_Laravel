...
@section('content')
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-title pt-5 ">
                        <!--begin::Search-->
                        <div class="d-flex  align-items-center position-relative my-1 px-3">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" id="search" class="form-control form-control-solid  ps-14"
                                placeholder="{{ __('dashboard.search') . ' ' . __('dashboard.user') }}" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card header-->
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            {{-- <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('users.create') }}" id="showmodal" type="button"
    ...
    @section('scripts')
        ...
        <script>
            $(document).on('change', '.userSwitch', function(e) {
                e.preventDefault();
