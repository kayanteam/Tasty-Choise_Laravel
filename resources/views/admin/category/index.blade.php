                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" id="search" class="form-control form-control-solid w-250px ps-14"
                                    placeholder="{{ __('dashboard.search') . ' ' . __('dashboard.category') }}" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('category.create') }}" id="showmodal" type="button"
                                    class="btn btn-dark">{{ __('dashboard.add_new_category') }}</a>
                            </div>
                            <!--end::Toolbar-->
