                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <style>
                            .image-input-placeholder {
                                background-image: url('{{ 'storage/' . $category->image ? asset('storage/' . $category->image) : asset('assets/media/svg/files/pic.jpg') }}');
                            }

                            [data-theme="dark"] .image-input-placeholder {
                                background-image: url('{{ 'storage/' . $category->image ? asset('storage/' . $category->image) : asset('assets/media/svg/files/blank-image-dark.svg') }}');
                            }
                        </style>
                        ...
                        <!--end::Image input-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7">{{ __('dashboard.category_image') }}
                        </div>
                    ...
                    <div class="row fv-plugins-icon-container">
                        ...
                        <div class="col-lg-4 d-flex align-items-center">
                            <div class="form-check form-check-solid form-check-custom form-switch">
                                ...
                                <input data-id="{{ $category->id }}" class="form-check-input w-45px h-30px sts-fld"
                                    type="checkbox" id="status_{{ $category->id }}" name="status" value="1"
