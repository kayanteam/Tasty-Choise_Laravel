                        ...
                        <form class="mb-5 fv-plugins-bootstrap5 fv-plugins-framework" id="details_form"
                            ...
                            <div class="row mb-6">
                                <div class="col-lg-3 mb-lg-0 mb-6">
                                    <label>الشركة:</label>
                                    <!--begin::Select2-->
                                    <select id="company_id" name="company_id" class="form-select mb-2"
                                        data-control="select2" data-placeholder="قم بتحديد الشركة" data-allow-clear="true">
                                        <option></option>
                                ...
                                <div class="col-lg-3 mb-lg-0 mb-6">
                                    ...
                                    <select id="category_id" name="category_id" class="form-select mb-2"
                                        data-control="select2" data-placeholder="قم بتحديد القسم" data-allow-clear="true">
                                        <option></option>
                                        {{-- @foreach ($companies as $comp)
                                            <option value="{{ $comp->id }}">{{ $comp->name }}</option>
                                        @endforeach --}}
                                ...
                                <div class="col-lg-3 mb-lg-0 mb-6">
                                    ...
                                    <!--end::Svg Icon-->
                                    <input id="start_date" class="form-control ps-12 datatable-input flatpickr-input active"
                                        placeholder="اختر تاريخ" lang="en" name="start_date" value="{{--now()->format('Y-m-d')--}}" type="date">
                                ...
                                <div class="col-lg-3 mb-lg-0 mb-6">
                                    ...
                                    <!--end::Svg Icon-->
                                    <input id="end_date" class="form-control ps-12 datatable-input flatpickr-input active"
                                        placeholder="اختر تاريخ" lang="en" name="end_date" type="date">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input id="search" type="text" data-kt-user-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="ابحث عن موظف" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
...
@section('scripts')
    ...
    <script>
        ...
        $('select[name=company_id]').on('change', function() {
            ...
            let url = "{{ route('company.getCategories', ':company_id') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('select[name=category_id]').append(data.html);
                }
            });
        });
