    ...
    <div class="card card-flush py-4">
        ...
        <div class="card-header">
            <div class="card-title">
                <h2>{{ __('dashboard.resturantSubscription') }}</h2>
            </div>
        </div>
        <!--end::Card header-->
        <!--begin::Card body-->
                    ...
                    <div class="card-body text-center pt-0">
                        ...
                        <style>
                            .image-input-placeholder {
                                background-image: url('{{ 'storage/' . $resturantSubscription->image ? asset('storage/' . $resturantSubscription->image) : asset('assets/media/svg/files/pic.jpg') }}');
                            }

                            [data-theme="dark"] .image-input-placeholder {
                                background-image: url('{{ 'storage/' . $resturantSubscription->image ? asset('storage/' . $resturantSubscription->image) : asset('assets/media/svg/files/blank-image-dark.svg') }}');
                            }
                        </style>
                        ...
                        <!--end::Image input-->
                        <!--begin::Description-->
                        <div class="text-muted fs-7">{{ __('dashboard.resturantSubscription_image') }}
                        </div>
                        ...
                        <div class="col-lg-4 d-flex align-items-center">
                            <div class="form-check form-check-solid form-check-custom form-switch">
                                ...
                                <input data-id="{{ $resturantSubscription->id }}" class="form-check-input w-45px h-30px sts-fld"
                                    type="checkbox" id="status_{{ $resturantSubscription->id }}" name="status" value="1"
                                    {{ old('status', $resturantSubscription->status ?? '') == 1 ? 'checked' : '' }}>
