                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" id="search" class="form-control form-control-solid w-250px ps-14"
                                    placeholder="{{ __('dashboard.search') . ' ' . __('dashboard.resturantSubscription') }}" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            {{-- <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('resturantSubscription.create') }}" id="showmodal" type="button"
                                    class="btn btn-dark">{{ __('dashboard.add_new_resturantSubscription') }}</a>
                            </div> --}}
                            <!--end::Toolbar-->
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            const oTable = $('#kt_ecommerce_resturantSubscription_table').DataTable();
            $(document).on('click', ".del_rec_btn", function(e) {
                e.preventDefault();
                const id = $(this).data('id');
                let url = "{{ route('resturantSubscription.destroy', ':id') }}";
    ...
    <script>
        $(document).on('click', '.sts-fld', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('resturantSubscription.status') }}",
                data: {
                    'id': id
                },
                success: function(data) {
