                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search" id="search"
                                    ...
                                    placeholder="{{ __('dashboard.search') . ' ' . __('dashboard.resturant') }}" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            {{-- <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('resturant.create') }}" id="showmodal" type="button"
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', ".del_rec_btn", function(e) {
                ...
                let url = "{{ route('resturant.destroy', ':id') }}";
    ...
    <script>
        $(document).on('change', '.resturantSwitch', function(e) {
            e.preventDefault();

            let id = $(this).data('id');

            $.ajax({
                url: "{{ route('resturant.status') }}",
                type: "post",
                data: {
                    id: id,
                },
