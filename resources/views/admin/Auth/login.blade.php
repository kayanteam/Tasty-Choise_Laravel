    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                        ...
                        <form class="form w-100" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-start mb-10">
                                    <!--begin::Title-->
                                    <h1 class="text-dark mb-3 fs-3x" data-kt-translate="sign-in-title">Tasty Choice  </h1>
                                    <!--end::Title-->
                                    <!--begin::Text-->
                                    <div class="text-gray-400 fw-semibold fs-6" data-kt-translate="general-desc">تسجيل
                                        الدخول فقط للمسؤولين</div>
                                    <!--end::Link-->
                                </div>
                                <!--begin::Heading-->
                                <!--begin::Input group=-->
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-10">
                                    ...
                                    <a href="../../demo1/dist/authentication/layouts/fancy/reset-password.html"
                                        class="link-primary" data-kt-translate="sign-in-forgot-password">هل نسيت كلمة
                                        المرور</a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Wrapper-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <button id="kt_sign_in_submit" class="btn btn-primary me-2 flex-shrink-0">
                                        ...
                                        <span class="indicator-label" data-kt-translate="sign-in-submit">دخول</span>
                                        <!--end::Indicator label-->
            ...
            <div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat"
                style="background-image: url('https://previews.123rf.com/images/nadianb/nadianb1602/nadianb160200256/52431014-organic-food-background-fresh-vegetables-useful-and-healthy-eating.jpg'); background-position: center; object-fit:cover"></div>
            <!--begin::Body-->
        </div>
