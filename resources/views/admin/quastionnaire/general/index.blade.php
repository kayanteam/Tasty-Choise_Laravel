                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-4 mb-lg-0 mb-6">
                                    ...
                                    <input id="start_date" class="form-control ps-12 datatable-input flatpickr-input active"
                                        placeholder="اختر تاريخ" name="start_date" type="date">
                                ...
                                <div class="col-lg-4 mb-lg-0 mb-6">
                                    ...
                                    <input id="end_date" class="form-control ps-12 datatable-input flatpickr-input active"
                                        placeholder="اختر تاريخ" name="end_date" type="date">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <!--begin::Add user-->
                                <a href="{{ route('add-geneal-quastionnaires') }}" class="btn btn-primary">
                                    ...
                                    <!--end::Svg Icon-->اضافة استبيان جديد
                                </a>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
