        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">الأقسام
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-3 mb-lg-0 mb-6">
                                    ...
                                    <input id="name_ar" class="form-control ps-12 datatable-input flatpickr-input active"
                                        placeholder="ادخل اسم القسم " name="start_date" type="text" value="">
                                </div>
