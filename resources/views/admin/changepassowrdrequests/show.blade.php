                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                            {{ __('dashboard.show_admin_details') }}</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">{{ __('dashboard.show_admins') }}</li>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item">
                                <span class="bullet bg-gray-400 w-5px h-2px"></span>
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">{{ __('dashboard.show_admin_details') }}</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                                                    ...
                                                    <div class="d-flex flex-column-fluid">
                                                        ...
                                                        <div class="image-input" data-kt-image-input="true">
                                                            ...
                                                            <div class="image-input-wrapper w-125px h-180px"
                                                                style="background-image: url('{{ asset('storage/' . $admin->image) }}')">
                                                            </div>
                                                                ...
                                                                <table class="col-lg-6 table fs-6 fw-bold gs-0 gy-2 gx-2">
                                                                    <tbody>
                                                                        <tr class="">
                                                                            ...
                                                                            <td class="text-gray-800">{{ $admin->name }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="">
                                                                            <td class="text-gray-400">
                                                                                {{ __('dashboard.phone') }}</td>
                                                                            <td class="text-gray-800">{{ $admin->phone }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr class="">
                                                                            <td class="text-gray-400">
                                                                                {{ __('dashboard.email') }}</td>
                                                                            <td class="text-gray-800">{{ $admin->email }}
                                                                            </td>
                                                                        </tr>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/custom/apps/ecommerce/catalog/save-admin.js') }}"></script>
    <script src="{{ asset('assets/js/widgets.bundle.js') }}"></script>
    <script src="{{ asset('assets/js/custom/widgets.js') }}"></script>
    <script src="{{ asset('assets/js/custom/utilities/modals/upgrade-plan.js') }}"></script>
    <script src="{{ asset('assets/js/custom/utilities/modals/create-app.js') }}"></script>
    <script src="{{ asset('assets/js/custom/utilities/modals/admin-search.js') }}"></script>
@endsection
