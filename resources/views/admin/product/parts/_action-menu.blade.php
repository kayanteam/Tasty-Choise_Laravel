  ...
  <td class="text-end m-3">
      ...
      <div class="d-flex my-3 ms-9">
        <a href="{{route('product.show', $model->id)}}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" data-bs-toggle="tooltip" data-kt-customer-payment-method="show" aria-label="Show" data-bs-original-title="Show" data-kt-initialized="1">
          ...
          <!--begin::Delete-->
          <a data-id="{{ $model->id }}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3 del_rec_btn"
              data-bs-toggle="tooltip" data-kt-customer-payment-method="delete" aria-label="Delete"
