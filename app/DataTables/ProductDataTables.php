...
class ProductDataTables extends DataTable
{
    ...
    public function dataTable($query): EloquentDataTable
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->editColumn('name', function (Product $modal) {

                return $modal->name;
            })
            ->editColumn('price', function (Product $modal) {
            ...
            ->addColumn('action', function (Product $model) {
                return view('admin.product.parts._action-menu', compact('model'));
            });
    }
